...
\begin{forest}
  ...
  [{Trustworthy Computer-Use Agents}
    ...
    [{Action \& Permission}, fill=green!10
      [{Authority Scoping \& Approval}
      ...
      [{Step Verification \& Staged Control}
      ...
      [{Runtime Enforcement \& Intervention}
    ...
    [{Memory \& Personalization}, fill=orange!10
      [{Stale \& Misleading Memory}
        [{\leafcites{\cInc{AgentProg~\cite{agentprog2025}},
          ...
          \cInc{MAGMA~\cite{jiang2026magma}},
          \cInc{Hippocampus~\cite{li2026hippocampus}},
          \cInc{Nemori~\cite{nan2025nemori}},
          \cInc{Memory in AI Agents~\cite{hu2025memory}}}}]
      ]
      [{Sensitive Retention \& Privacy Leakage}
      ...
      [{Memory Poisoning \& Evaluation Gaps}
        [{\leafcites{\cInc{MemGUI-Bench~\cite{memguibench2026}},
          ...
          \cInc{Anatomy of Agentic Memory~\cite{jiang2026anatomy}}}}]
      ]
    ]
    [{Tool, Skill \& Ecosystem}, fill=violet!8
      [{Skill Abstraction \& Ecosystem Trust}
      ...
      [{Injection \& Poisoning at Skill Boundary}
      ...
      [{Ecosystem Propagation \& Systemic Risk}
    ...
    [{Human Oversight \& Governance}, fill=red!8
      ...
      [{During Execution: Handoff \& Auditability}
      ...
      [{Post-execution: Rollback \& Remediation}
        [{\leafcites{\cSaf{OS-Harm~\cite{osharm2025}},
          \cSaf{PRISM~\cite{openclawprism2026}},
          \cSaf{OpenClaw audit~\cite{clawaudit2026}},
          \cTra{MCP threat model~\cite{hou2025mcp}}}}]
